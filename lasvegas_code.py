...
class RulesWindow(QWidget):
    def __init__(self, user, parent=None):
        ...
        rules.setText('''Правила игры:
                      ...
                      1) Если выпали одинаковые числа - ваш куш удваивается. Если выпало две шестерки - утраивается.
                      2) Если выпало загаданное число - вы получаете столько очков, сколько поставили.
